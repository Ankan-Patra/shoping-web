...
const Cart = () => {
  const { products, currency, cartItem, updateQuantity , navigator } = useContext(ShopContext);
      ...
      <div className='flex justify-end my-20'>
        <div className='w-full sm:w-[450px]'>
           ...
           <div className='w-full text-end'>
               <button onClick={()=>navigator('/place-order')} className='bg-black text-white text-sm my-8  px-8 py-3'>PROCEED TO CHECKOUT</button>
           </div>
        </div>
      </div>
    </div>
