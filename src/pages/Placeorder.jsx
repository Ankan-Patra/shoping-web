  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <input type="text" placeholder='Place' className='border border-gray-300 rounded py-1.5 px-3.5 w-full ' />
        <div className='flex gap-3'>
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='w-full text-end mt-8'>
            <button onClick={()=>navigator('/orders')} className='bg-black text-white px-16 py-3 text-sm'>PLACE ORDER</button>
          </div>
        </div>
      </div>
    </div>
